...
class Flooding extends Component {
    ...
    loadFlooding = () => {
        API.getFlooding()
            .then(res =>
                this.setState({ Flooding: res.data, title: "", author: "", link: "", body: "" })
            ...
            <div>
                <Container fluid>
                    <Row>
                        <Col size="md-1" />
                        <Col size="md-4">
                            <h1 className="pageHeader">Flooding Prep</h1>
                        </Col>
                        <Col size="md-7" />
                    </Row>
                        ...
                        <Col size="md-8">
                            <div className="panel panel-default panel-primary">
                                <div className="panel-heading">
                                    <h3 className="panel-title">Floodings</h3>
                                </div>
